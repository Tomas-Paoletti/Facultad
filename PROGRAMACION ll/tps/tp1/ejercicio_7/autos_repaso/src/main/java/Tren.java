...
public class Tren extends Vehiculo{ 
    ...
    public Tren(double km_recorrer, double vel_automovil, double autonomia, double tiempo_carga_comb, double tiempo_recorrido) {
        super(km_recorrer, vel_automovil=70, autonomia=1, tiempo_carga_comb=0, tiempo_recorrido);
    }
