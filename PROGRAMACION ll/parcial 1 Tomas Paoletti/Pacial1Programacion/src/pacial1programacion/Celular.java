...
public class Celular extends Dispositivo{
    ...
    public Integer getNroserie() {
        return super.getNroserie(); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void setNroserie(Integer nroserie) {
        super.setNroserie(nroserie); //To change body of generated methods, choose Tools | Templates.
    }
