...
public class Moto extends Vehiculo{
    ...
    public Moto(double km_recorrer, double vel_automovil, double autonomia, double tiempo_carga_comb, double tiempo_recorrido) {
        super(km_recorrer, vel_automovil=150, autonomia=700, tiempo_carga_comb=0.5, tiempo_recorrido);
    }
